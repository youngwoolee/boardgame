...
public class InitConfig {
    ...
    CommandLineRunner init(GameRepository gameRepository, GenreRepository genreRepository, SystemTypeRepository systemTypeRepository) {
        return args -> {
            ...
            games.addAll(createGames("스플렌더", "보석 상인이 되어 보석을 수집하고, 카드와 귀족을 구매해 점수를 얻는 전략형 보드게임입니다.",
                                     "https://raw.githubusercontent.com/youngwoolee/boardgame-image/main/images/b56fa977-695e-47b1-9d5b-f861663f152a.webp", "hot", 2, 4, 10, "30분 내외",
            ...
            games.addAll(createGames("아발론", "아발론은 선과 악의 세력이 대결하는 정체 은닉 기반의 심리전 게임입니다.",
                                     "https://raw.githubusercontent.com/youngwoolee/boardgame-image/main/images/3405d1e3-f9c3-4469-b5dc-020efcfb8c4b.webp", "new", 5, 10, 14, "30~60분",
            ...
            games.addAll(createGames("티켓 투 라이드", "미국 전역의 기차 노선을 연결하며 점수를 얻는 게임입니다.",
                                     "https://raw.githubusercontent.com/youngwoolee/boardgame-image/main/images/e069910f-33ce-4a10-8a56-780d9bc92a52.webp", "new", 2, 5, 8, "30~60분",
            ...
            games.addAll(createGames("도블", "카드에 그려진 그림을 빠르게 매칭하는 게임입니다.",
                                     "https://raw.githubusercontent.com/youngwoolee/boardgame-image/main/images/f31fbb2d-6e43-468b-97ef-b378fe8b9005.png", null, 2, 8, 6, "15분 내외",
            ...
            games.addAll(createGames("한밤의 늑대인간", "정체를 숨기고 토론을 통해 적을 찾아내는 정체 은닉 게임입니다.",
                                     "https://raw.githubusercontent.com/youngwoolee/boardgame-image/main/images/aa3b8d2b-c9f7-4a03-a983-c459e8f25302.png", "new", 3, 10, 10, "10~15분",
            ...
            games.addAll(createGames("스컬킹", "카드를 예측해 베팅하고 점수를 얻는 트릭테이킹 카드 게임입니다.",
                                     "https://raw.githubusercontent.com/youngwoolee/boardgame-image/main/images/ef27caf3-c84f-42f3-89a4-5d14d1cbc3fa.jpeg", null, 2, 6, 10, "30분 내외",
            ...
            games.addAll(createGames("사보타지", "광부와 사보타지 팀이 대결하는 협력 및 방해 게임입니다.",
                                     "https://raw.githubusercontent.com/youngwoolee/boardgame-image/main/images/01d7d24a-b7d9-43a4-8a90-ea85fbe93e87.jpeg", "hot", 3, 10, 8, "30분 내외",
    ...
    private List<Game> createGames(String name, String description, String imageUrl, String tag,
                                   int minPlayers, int maxPlayers, int age, String time,
